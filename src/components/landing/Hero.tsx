...
const Hero = () => {
  return (
    <section className="h-[650px] flex flex-col items-center  " id="inicio">
      <div className="w-full flex h-full justify-evenly items-center flex-col lg:flex-row">
        <div className="text-5xl  w-xl p-2 space-y-6 ">
          ...
          <div className="text-[25px] h-10 flex justify-start items-center">
            <a className="border-2 text-[#074799] px-4 py-3 rounded-xl font-bold cursor-pointer transition-all hover:bg-gradient-to-r from-blue-800 to-blue-600 hover:text-white  ">
